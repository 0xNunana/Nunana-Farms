...
const Info = () => {
  return (
    ...
    <p className='text-4xl sm:text-7xl font-bold animate-fadeIn'>Comprehensive suite of solutions to maximise your <span className=' text-green-300 '>farm&apos;s potential.</span></p>
...
<div className='w-[90%] sm:w-[60%] text-center flex justify-center items-center mx-auto space-x-4 my-5'>
  <div className='bg-zinc-800 rounded-lg px-4 py-2 text-yellow-400 animate-fadeL '>
    <p className='a'>Explore our providers</p>
  </div>
